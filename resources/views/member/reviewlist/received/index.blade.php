...
@section('content')
    ...
    <input type="hidden" id="markcompleted-action-url" value="{{ route('member.reviewList.markAsCompleted') }}" />
@push('scripts')
...
<script>
                                    ...
                                    <div class="add-hold-btn d-flex">
                                        ...
                                        ${reply.suggested_remarks != null ?
                                            `<a href="#" class="tooltip-msg">
                                             ...
                                             `<a href="#"  id="add-comment-btn"  data-id="${reply.id}"  class="add-msg-ico"></a>` }
    ...
    function loadReviewSendList(){
        var fetchSendItemsAction = "{{ route('member.reviewList.fetchAllReceivedEnquiries') }}";
                                ...
                                <div class="list-item-inner yellow-border">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div id="mark-drop">
                                            ...
                                            <ul class="drop">
                                                <li class="markCompleted" data-id="${enquiry.id}" data-reference_no="${enquiry.reference_no}">Mark as Complete</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="d-flex w-100 justify-content-between">
