<header class="navbar">
        <div class="header header-inner container-fluid navbar-default d-flex">
            ...
            <div class="side-nav-main">
                ...
                <ul>
                    <li class="d-flex align-items-center active my-quotes"><a href="{{ route('procurement.dashboard') }}"> <i><img
                                    src="{{ asset('assets/images/my-quotes-ico.svg') }}"></i></a><a href="{{ route('procurement.dashboard') }}" class="nav-txt"> My
                            Quotes</a>
                            
                    </li>
                    <li class="d-flex align-items-center review-list"><a href="{{ route('procurement.reviewList') }}"> <i><img
                                    src="{{ asset('assets/images/review-list-ico.svg') }}"></i></a><a href="{{ route('procurement.reviewList') }}"
                            class="nav-txt">Review List</a>
                    </li>
                    <li class="d-flex align-items-center draft"><a href="{{ route('procurement.draft') }}"> <i><img
                                    src="{{ asset('assets/images/draft-ico.svg') }}"></i></a><a href="{{ route('procurement.draft') }}" class="nav-txt">Draft</a>
                    </li>
                    <li class="d-flex align-items-center completed-bidding"><a href="{{ route('procurement.completedBidding') }}"> <i><img
                                    src="{{ asset('assets/images/completed-bidding-ico.svg') }}"></i></a><a href="{{ route('procurement.completedBidding') }}"
                            class="nav-txt">Completed
                            Bidding </a></li>
                    <li class="d-flex align-items-center team-settings"><a href="{{ route('procurement.teamAccount') }}"> <i><img
                                    src="{{ asset('assets/images/team-settings-ico.svg') }}"></i></a><a href="{{ route('procurement.teamAccount') }}"
                            class="nav-txt">Team Settings
                            & Approvals</a></li>
                    <li class="d-flex align-items-center upcoming-events"><a href="{{ route('procurement.upcomingEvents') }}"> <i><img
